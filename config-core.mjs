...
import { normalizeReasoningConfig } from './reasoning-config.mjs';

export { CHAT_REASONING_PARAMETERS, normalizeReasoningConfig } from './reasoning-config.mjs';
...
export function normalizeProvider(input, existing = null) {
  ...
  const models = rawModels.map(model => {
    ...
    const inferredCapabilities = inferModelCapabilities(upstreamModel);
