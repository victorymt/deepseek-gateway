export const providerCopy = {
  en: {
    ...
    keyRouting: "Key routing",
    balancedKeyRouting: "Balanced",
    promptCacheAffinityRouting: "Prompt cache affinity",
  ...
  "zh-CN": {
    ...
    keyRouting: "密钥调度",
    balancedKeyRouting: "负载均衡",
    promptCacheAffinityRouting: "Prompt Cache 粘性",
    apiProfile: "API Profile",
